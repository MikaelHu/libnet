...
//              NMemoryStorage will create all these size of MemoryPool, and you can
...
public:
    ...
    explicit NMemoryStorage(size_t init_size, std::initializer_list<size_t> il_type_sizes) {
    ...
    pT Alloc(size_t size)
    {
        ...
        MemPoolNode* p_mem_pool_node = new MemPoolNode();
